...
function newSigningKeyForAccessToken(connection, signingKey, createdAt) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield connection.executeQuery(query, [accessToken_1.DB_KEY_FOR_SIGNING_KEY_ACCESS_TOKEN, signingKey, createdAt]);
    });
}
...
function getSigningKeyForAccessToken(connection) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const results = yield connection.executeQuery(query, [accessToken_1.DB_KEY_FOR_SIGNING_KEY_ACCESS_TOKEN]);
        if (results.length === 0) {
            return undefined;
        }
        return {
...
function updateSingingKeyForAccessToken(connection, signingKey, createdAt) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield connection.executeQuery(query, [signingKey, createdAt, accessToken_1.DB_KEY_FOR_SIGNING_KEY_ACCESS_TOKEN]);
    });
}
