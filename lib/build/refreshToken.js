    ...
    constructor() {
        ...
        this.generateNewKeyAndUpdateInDb = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let key = yield dbQueries_1.getKeyValueFromKeyName_Transaction(connection, REFRESH_TOKEN_KEY_NAME_IN_DB);
                if (key === undefined) {
                    ...
                    yield dbQueries_1.insertKeyValueForKeyName_Transaction(connection, REFRESH_TOKEN_KEY_NAME_IN_DB, key.keyValue, key.createdAtTime);
                }
