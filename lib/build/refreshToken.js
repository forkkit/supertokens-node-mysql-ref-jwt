    ...
    constructor() {
        ...
        this.generateNewKeyAndUpdateInDb = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let keys = yield dbQueries_1.getKeyValueFromKeyName(connection, REFRESH_TOKEN_KEY_NAME_IN_DB);
                if (keys.length === 0) {
                    ...
                    yield dbQueries_1.insertKeyValueForKeyName(connection, REFRESH_TOKEN_KEY_NAME_IN_DB, keys[0].keyValue, keys[0].createdAtTime);
                }
