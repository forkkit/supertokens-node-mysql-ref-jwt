...
function generate32CharactersRandomString() {
    return crypto_1.createHash("md5").update(Date.now().toString()).digest("hex"); // TODO: DO NOT USE MD5!!!!!!!!
}
...
function generate24CharactersRandomString() {
    return crypto_1.createHash("md5").update(Date.now().toString()).digest("base64"); // TODO: DO NOT USE MD5!!!!!!!!
}
