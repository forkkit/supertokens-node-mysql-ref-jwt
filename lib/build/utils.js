...
function generate40CharactersRandomString() {
    return crypto_1.createHash("sha1").update(Date.now().toString() + crypto_1.randomBytes(8)).digest("hex");
}
exports.generate40CharactersRandomString = generate40CharactersRandomString;
function generate24CharactersRandomString() {
    return crypto_1.createHash("md5").update(Date.now().toString() + crypto_1.randomBytes(8)).digest("base64");
}
exports.generate24CharactersRandomString = generate24CharactersRandomString;
function hash(stringText) {
    return crypto_1.createHash("md5").update(stringText).digest("hex");
}
exports.hash = hash;
