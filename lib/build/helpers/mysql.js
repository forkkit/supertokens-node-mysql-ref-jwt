...
function createTablesIfNotExists() {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        if (
            (yield checkIfSigningKeyTableExists()) &&
            (yield checkIfRefreshTokensTableExists()) &&
            (yield checkIfAllTokensTableExists())
        ) {
            return;
        }
        const config = config_1.default.get();
...
function checkIfAllTokensTableExists() {
    return __awaiter(this, void 0, void 0, function*() {
        const config = config_1.default.get();
        let allTokensTableName = config.mysql.tables.allTokens;
        let connection = yield getConnection();
        try {
            yield dbQueries_1.checkIfTableExists(connection, allTokensTableName);
            return true;
        } catch (err) {
            // i.e. tables don't exist
            return false;
...
exports.checkIfAllTokensTableExists = checkIfAllTokensTableExists;
