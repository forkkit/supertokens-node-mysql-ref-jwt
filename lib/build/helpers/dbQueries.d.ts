...
export declare function createNewSession(connection: Connection, sessionHandle: string, userId: string, refreshTokenHash2: string, sessionData: any, expiresAt: number, jwtPayload: any): Promise<void>;
...
export declare function getAllSessionHandlesForUser(connection: Connection, userId: string): Promise<string[]>;
