...
function updateSessionInfo(connection, sessionHandle, sessionInfo) {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        let result = yield connection.executeQuery(query, [serialiSessionInfo(sessionInfo), sessionHandle]);
...
function serialiSessionInfo(data) {
    if (data === undefined) {
        return "";
    } else {
...
function unserialiSessionInfo(data) {
    if (data === "") {
        return undefined;
    } else {
        try {
