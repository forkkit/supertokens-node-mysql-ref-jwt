...
function updateSessionInfo(connection, sessionHandle, sessionInfo) {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        let result = yield connection.executeQuery(query, [serialiSesessionInfo(sessionInfo), sessionHandle]);
...
function serialiSesessionInfo(data) {
    if (data === undefined) {
        return "";
    } else {
...
function unserialiSesessionInfo(data) {
    if (data === "") {
        return undefined;
    } else {
        try {
