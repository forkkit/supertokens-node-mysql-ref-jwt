...
function updateSessionData(connection, sessionHandle, sessionData) {
    return __awaiter(this, void 0, void 0, function*() {
        let sessionHandleHash1 = utils_1.convertSessionHandleForDatabaseQuery(sessionHandle);
        const config = config_1.default.get();
...
function getAllSessionHandlesForUser(connection, userId) {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        return result.map(i => utils_1.convertDatabaseFetchedSessionToSendToUser(i.session_handle_hash_1.toString()));
    });
}
