...
function updateSessionData(connection, sessionHandleHash1, sessionData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield connection.executeQuery(query, [serialiseSessionData(sessionData), sessionHandleHash1]);
    });
}
...
function createNewSession(connection, sessionHandleHash1, userId, refreshTokenHash2, sessionData, expiresAt, jwtPayload) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = config_1.default.get();
    ...
    session_info, expires_at, jwt_user_payload) VALUES (?, ?, ?, ?, ?, ?)`;
        yield connection.executeQuery(query, [sessionHandleHash1, userId, refreshTokenHash2, serialiseSessionData(sessionData), expiresAt, serialiseSessionData(jwtPayload)]);
    });
}
