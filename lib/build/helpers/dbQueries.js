...
function createNewSession(connection, sessionHandleHash1, userId, refreshTokenHash2, sessionData, expiresAt) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = config_1.default.get();
    ...
    session_info, expires_at) VALUES (?, ?, ?, ?, ?)`;
        yield connection.executeQuery(query, [sessionHandleHash1, userId, refreshTokenHash2, serialiseSessionData(sessionData), expiresAt]);
    });
}
