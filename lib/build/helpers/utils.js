...
function convertSessionHandleForDatabaseQuery(sessionHandle) {
...
exports.convertSessionHandleForDatabaseQuery = convertSessionHandleForDatabaseQuery;
function convertDatabaseFetchedSessionToSendToUser(sessionHandle) {
    if (sessionHandle.endsWith(".v1")) {
        return sessionHandle;
    } else {
...
exports.convertDatabaseFetchedSessionToSendToUser = convertDatabaseFetchedSessionToSendToUser;
