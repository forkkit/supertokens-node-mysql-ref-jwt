...
function createTablesIfNotExists() {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        try {
            yield dbQueriesOld_1.createTablesIfNotExists(connection, signingKeyTableName, refreshTokensTableName);
        } finally {
...
function checkIfSigningKeyTableExists() {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        let connection = yield getConnection();
        try {
            yield dbQueriesOld_1.checkIfTableExists(connection, signingKeyTableName);
            return true;
        } catch (err) {
...
function checkIfRefreshTokensTableExists() {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        let connection = yield getConnection();
        try {
            yield dbQueriesOld_1.checkIfTableExists(connection, refreshTokensTableName);
            return true;
        } catch (err) {
            // i.e. tables don't exist
            return false;
...
//# sourceMappingURL=mysqlOld.js.map
