...
function createNewSession(res, userId, jwtPayload, sessionData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield dbQueries_1.createNewSession(connection, sessionHandle, userId, utils_1.hash(utils_1.hash(refreshToken.token)), sessionData, refreshToken.expiry);
        }
        finally {
        ...
        try {
            ...
            if (promote || sessionInfo.refreshTokenHash2 === utils_1.hash(accessTokenInfo.refreshTokenHash1)) {
                if (promote) {
                    ...
                    yield dbQueries_1.updateSessionInfo_Transaction(connection, sessionHandle, utils_1.hash(accessTokenInfo.refreshTokenHash1), sessionInfo.sessionData, Date.now() + config.tokens.refreshToken.validity);
                }
                yield connection.commit();
