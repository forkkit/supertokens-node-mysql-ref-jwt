...
function createNewSession(res, userId, jwtPayload, sessionData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield dbQueries_1.createNewSession(connection, utils_1.hash(sessionHandle), userId, utils_1.hash(utils_1.hash(refreshToken.token)), sessionData, refreshToken.expiry);
        }
        finally {
...
function refreshSession(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield refreshSessionHelper(res, refreshToken, refreshTokenInfo);
    });
}
