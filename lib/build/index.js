...
function getSession(req, res) {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        try {
            let response = yield SessionFunctions.getSession(accessToken);
    ...
    return __awaiter(this, void 0, void 0, function*() {
        ...
        try {
            ...
            if (response.sessionTheftDetected) {
                ...
                // attach tokens to cookies
                cookie_1.attachAccessTokenToCookie(res, response.newAccessToken.value, response.newAccessToken.expires);
                cookie_1.attachRefreshTokenToCookie(
                    res,
...
function getAllSessionHandlesForUser(userId) {
    return __awaiter(this, void 0, void 0, function*() {
        return yield SessionFunctions.getAllSessionHandlesForUser(userId);
    });
}
...
function getSessionData(sessionHandle) {
    return __awaiter(this, void 0, void 0, function*() {
        return yield SessionFunctions.getSessionData(sessionHandle);
    });
}
...
function updateSessionData(sessionHandle, newSessionData) {
    return __awaiter(this, void 0, void 0, function*() {
        return yield SessionFunctions.updateSessionData(sessionHandle, newSessionData);
    });
}
