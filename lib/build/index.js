    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (parentRefreshToken !== null) {
                jwtPayload.pRTHash = utils_1.hash(parentRefreshToken);
            }
...
function refreshSession(request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            return yield newSession(response, parentRefreshTokenInfo.userId, parentToken, parentRefreshTokenInfo.sessionId, parentRefreshTokenInfo.metaInfo);
        }
        catch (err) {
            mysqlConnection.setDestroyConnection();
            throw err;
