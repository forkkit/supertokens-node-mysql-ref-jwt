...
function getSession(request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let jwtPayload = yield accessToken_1.verifyTokenAndGetPayload(accessToken, connection);
...
function createNewSession(request, response, userId, metaInfo) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield newSession(request, response, userId, metaInfo, null, null);
    });
}
exports.createNewSession = createNewSession;
function newSession(request, response, userId, metaInfo, parentRefreshToken, sessionId) {
    return __awaiter(this, void 0, void 0, function* () {
        const connection = yield mysql_1.getConnection();
        try {
            metaInfo = utils_1.serializeMetaInfo(metaInfo);
            const config = config_1.Config.get();
            const refreshToken = yield refreshToken_1.getNewRefreshToken(userId, metaInfo, parentRefreshToken, sessionId, connection);
...
function refreshSession(request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (parentRefreshTokenInfo === undefined || decryptedInfoForRefreshToken.userId !== parentRefreshTokenInfo.userId || utils_1.hash(decryptedInfoForRefreshToken.sessionId) !== parentRefreshTokenInfo.sessionId) {
                ...
                if (decryptedInfoForRefreshToken.parentToken !== null) {
                    ...
                    if (parentRefreshTokenInfo === undefined || parentRefreshTokenInfo.userId !== decryptedInfoForRefreshToken.userId) {
                        yield refreshToken_1.checkIfSessionIdExistsAndNotifyForTokenTheft(connection, utils_1.hash(decryptedInfoForRefreshToken.sessionId));
                        /**
                         * @todo
                         */
                        throw Error();
            ...
            return yield newSession(request, response, parentRefreshTokenInfo.userId, parentRefreshTokenInfo.metaInfo, parentToken, parentRefreshTokenInfo.sessionId);
        }
        catch (err) {
            connection.setDestroyConnection();
            /**
