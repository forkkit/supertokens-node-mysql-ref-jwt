...
function createNewAccessToken(sessionHandle, userId, refreshTokenHash1, parentRefreshTokenHash1, userPayload) {
    return __awaiter(this, void 0, void 0, function* () {
        let config = config_1.default.get();
        let signingKey = yield SigningKey.getKey();
    ...
    constructor(config) {
        ...
        this.generateNewKeyAndUpdateInDb = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let keys = yield dbQueries_1.getKeyValueFromKeyName_Transaction(connection, ACCESS_TOKEN_SIGNING_KEY_NAME_IN_DB);
                ...
                if (generateNewKey) {
                    ...
                    yield dbQueries_1.insertKeyValueForKeyName_Transaction(connection, ACCESS_TOKEN_SIGNING_KEY_NAME_IN_DB, keys[0].keyValue, keys[0].createdAtTime);
                }
