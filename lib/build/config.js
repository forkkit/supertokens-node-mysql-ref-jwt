...
class Config {
    ...
    static get() {
        if (Config.instance === undefined) {
            throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("configs not set. Please call the init function before using this library"), false);
        }
...
const validateAndNormalise = (config) => {
    if (config === null || typeof config !== "object") {
        throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("passed config is not an object"), false);
    }
    const mysqlInputConfig = config.mysql;
    if (typeof mysqlInputConfig !== "object") {
        throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("mysql config not passed. user, password and database are required"), false);
    }
    ...
    if (user === undefined) {
        throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("mysql config error. user not passed"), false);
    }
    const password = utils_1.sanitizeStringInput(mysqlInputConfig.password);
    if (password === undefined) {
        throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("mysql config error. password not passed"), false);
    }
    ...
    if (database === undefined) {
        throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("mysql config error. database not passed"), false);
    }
    let tables;
    ...
    if (accessTokenInputConfig !== undefined) {
        ...
        if (signingKeyInputConfig !== undefined) {
            ...
            if (updateInterval !== undefined) {
                if (updateInterval > defaultConfig.tokens.accessToken.signingKey.updateInterval.max) {
                    throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("update interval passed for updating singingKey for access token is not within allowed interval. (Note: value passed will be in units of hours)"), false);
                }
            ...
            if (get !== undefined && typeof get !== "function") {
                throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("config > tokens > accessToken > get must be a function"), false);
            }
            signingKey = {
                dynamic,
                updateInterval,
        ...
        if (validity !== undefined) {
            if (validity > defaultConfig.tokens.accessToken.validity.max) {
                throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("passed value for validity of access token is not within allowed interval. (Note: value passed will be in units of seconds)"), false);
            }
    ...
    if (typeof refreshTokenInputConfig !== "object") {
        throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("refreshToken config not passed. renewTokenPath is required"), false);
    }
    ...
    if (validity !== undefined) {
        if (validity > defaultConfig.tokens.refreshToken.validity.max) {
            throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("passed value for validity of refresh token is not within allowed interval. (Note: value passed will be in units of hours)"), false);
        }
    ...
    if (loggingInputConfig !== undefined) {
        ...
        if (info !== undefined && typeof info !== "function") {
            throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("logging config error. info option passed must be a function"), false);
        }
        if (error !== undefined && typeof error !== "function") {
            throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("logging config error. error option passed must be a function"), false);
        }
        logging = {
            info,
            error
    ...
    if (domain === undefined) {
        throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("domain parameter for cookie not passed"), false);
    }
    const cookie = {
        domain,
        secure
    ...
    if (onTokenTheftDetectionFromUser !== undefined) {
        if (typeof onTokenTheftDetectionFromUser !== "function") {
            throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("onTokenTheftDetection must be a function"), false);
        }
