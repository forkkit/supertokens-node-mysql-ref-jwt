...
function createNewSession(userId, jwtPayload, sessionData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return {
            session: {
                handle: sessionHandle, userId, jwtPayload
            },
            accessToken: { value: accessToken.token, expires: accessToken.expiry },
            refreshToken: { value: refreshToken.token, expires: refreshToken.expiry },
        ...
        try {
            ...
            if (sessionInfo.refreshTokenHash2 === utils_1.hash(utils_1.hash(refreshToken))) {
                ...
                return {
                    ...
                    newAccessToken: { value: newAccessToken.token, expires: newAccessToken.expiry },
                    newRefreshToken: { value: newRefreshToken.token, expires: newRefreshToken.expiry },
                    newIdRefreshToken: { value: utils_1.generateUUID(), expires: newRefreshToken.expiry }
                };
            }
...
function revokeSessionUsingSessionHandleHelper(sessionHandleHash1) {
    return __awaiter(this, void 0, void 0, function* () {
        let connection = yield mysql_1.getConnection();
        try {
            let numberOfAffectedRows = yield dbQueries_1.deleteSession(connection, sessionHandleHash1);
...
function getSessionData(sessionHandle) {
    return __awaiter(this, void 0, void 0, function* () {
        let connection = yield mysql_1.getConnection();
        try {
            let result = yield dbQueries_1.getSessionData(connection, utils_1.hash(sessionHandle));
            if (!result.found) {
...
function updateSessionData(sessionHandle, newSessionData) {
    return __awaiter(this, void 0, void 0, function* () {
        let connection = yield mysql_1.getConnection();
        try {
            let numberOfAffectedRows = yield dbQueries_1.updateSessionData(connection, utils_1.hash(sessionHandle), newSessionData);
