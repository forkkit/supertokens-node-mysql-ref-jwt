...
function createNewSession(userId, jwtPayload, sessionData) {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        // generate tokens:
        let refreshToken = yield refreshToken_1.createNewRefreshToken(
            sessionHandle,
            userId,
            undefined
        );
 ...
 */
function getSession(idRefreshToken, accessToken) {
    return __awaiter(this, void 0, void 0, function*() {
        ...
        try {
            ...
            let sessionInfo = yield dbQueries_1.getSessionInfo_Transaction(
                connection,
                utils_1.hash(sessionHandle)
            );
            ...
            let promote =
                ...
                utils_1.hash(accessTokenInfo.parentRefreshTokenHash1);
            if (
                promote ||
                sessionInfo.refreshTokenHash2 ===
 ...
 */
function refreshSession(idRefreshToken, refreshToken) {
    return __awaiter(this, void 0, void 0, function*() {
        let config = config_1.default.get();
        ...
        let refreshTokenInfo = yield refreshToken_1.getInfoFromRefreshToken(
            refreshToken
        );
    ...
    return __awaiter(this, void 0, void 0, function*() {
        ...
        try {
            ...
            if (
                ...
                utils_1.hash(refreshTokenInfo.parentRefreshTokenHash1) ===
                    sessionInfo.refreshTokenHash2
            ) {
                ...
                return yield refreshSessionHelper(
                    refreshToken,
                    refreshTokenInfo
                );
            }
...
function revokeAllSessionsForUser(userId) {
    return __awaiter(this, void 0, void 0, function*() {
        let connection = yield mysql_1.getConnection();
        try {
            let sessionHandleHash1List = yield dbQueries_1.getAllHash1SessionHandlesForUser(
                connection,
                userId
            );
            for (let i = 0; i < sessionHandleHash1List.length; i++) {
                yield revokeSessionUsingSessionHandleHelper(
...
function revokeSessionUsingSessionHandle(sessionHandle) {
    return __awaiter(this, void 0, void 0, function*() {
        return yield revokeSessionUsingSessionHandleHelper(
            utils_1.hash(sessionHandle)
        );
    });
}
...
function revokeSessionUsingSessionHandleHelper(sessionHandleHash1) {
    return __awaiter(this, void 0, void 0, function*() {
        let connection = yield mysql_1.getConnection();
        try {
            let numberOfAffectedRows = yield dbQueries_1.deleteSession(
                connection,
                sessionHandleHash1
            );
...
function getSessionData(sessionHandle) {
    return __awaiter(this, void 0, void 0, function*() {
        let connection = yield mysql_1.getConnection();
        try {
            let result = yield dbQueries_1.getSessionData(
                connection,
                utils_1.hash(sessionHandle)
            );
            if (!result.found) {
...
function updateSessionData(sessionHandle, newSessionData) {
    return __awaiter(this, void 0, void 0, function*() {
        let connection = yield mysql_1.getConnection();
        try {
            let numberOfAffectedRows = yield dbQueries_1.updateSessionData(
                connection,
                utils_1.hash(sessionHandle),
                newSessionData
            );
