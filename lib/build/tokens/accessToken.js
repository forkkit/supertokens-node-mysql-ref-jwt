    ...
    getKey(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.key === undefined) {
                // TODO: transaction!
                const key = yield tokens_1.getSigningKeyForAccessToken(connection);
                if (key === undefined) {
...
function verifyTokenAndGetPayload(token, connection) {
    return __awaiter(this, void 0, void 0, function* () {
        let payload = yield jwt_1.verifyAndGetPayload(token, getAccessTokenSigningKey, connection);
...
function updateAccessTokenInHeaders(payload, response, connection) {
    return __awaiter(this, void 0, void 0, function* () {
        const accessToken = yield jwt_1.createNewJWT(payload, connection);
        const config = config_1.Config.get();
